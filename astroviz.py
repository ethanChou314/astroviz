...
# private function to convert relative coordinates to absolute coordinates
...
# private function so that units like u.Jy/u.beam*u.km/u.s are converted to in-line latex in that same order.
